...
function CallAnswerBuilder({ questions, onUpdateQuestion, onDeleteQuestion, onAIAssistance }) {
  ...
  return (
    <div className="call-answer-builder">
      {questions.map((question, index) => (
        <div key={question.id} className="question-card">
          ...
          <div className="question-form">
            ...
            <div className="form-row">
              <div className="form-group full-width">
                <label>Detailed Lesson/Context</label>
                <textarea
                  value={question.detail}
                  onChange={(e) => handleQuestionChange(index, 'detail', e.target.value)}
                  placeholder="Provide background information, context, or detailed explanation"
          ...
          <div className="question-preview">
            ...
            <div className="preview-content">
              ...
              {question.detail && (
                <>
                  <strong>Context:</strong> {question.detail.substring(0, 100)}
                  {question.detail.length > 100 ? '...' : ''}
                </>
              )}
            </div>
          </div>
...
export default CallAnswerBuilder;
