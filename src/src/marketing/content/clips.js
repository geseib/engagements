...
export const CLIPS = {
  'trivia-host': slot('tv', 'Trivia on the big screen',
    'The host screen shows a trivia question with four choices, answers lock in, then the correct answer and the top three appear.'),
  'trivia-player': slot('phone', 'Answering on a phone, tablet or laptop',
  ...
  'poll-host': slot('tv', 'Call and answer on the big screen',
    'The host screen shows a prompt and a count of answers coming in, then every answer goes up for the vote, and the results are revealed with a summary.'),
  'poll-player': slot('phone', 'Adding an idea, then voting',
    'A phone shows the prompt; the player types an idea and sends it, then ranks the three answers they like best.'),
