module.exports = {
  ...
  // gives its draftIt() wait 4000ms, because coming back enabled can cost a
  // real poll cycle. Under jest's 5000ms default that inner budget was
  // effectively unreachable in a loaded run — jest could kill the test before
  // a wait anywhere close to its own limit ever got there. Any testTimeout set
  // here must stay above the largest waitFor budget in the suite or it
