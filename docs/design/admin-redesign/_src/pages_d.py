      ...
      <section class="panel">
        ...
        <div class="body flush">
          <dl class="kv">
            ...
            <div><dt>API</dt><dd class="mono">https://ouv6fztlig.execute-api.us-east-1.amazonaws.com/dev</dd></div>
            <div><dt>Front end</dt><dd class="mono">https://engage.dev.seibtribe.us</dd></div>
