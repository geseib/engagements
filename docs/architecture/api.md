...
| POST | `/games/{gameId}/survey/close` | **Cognito** | `lambda-functions/game/survey-host.js` |
| POST | `/games/{gameId}/survey/end` | **Cognito** | `lambda-functions/game/survey-host.js` |
| POST | `/games/{gameId}/survey/mine` | public | `lambda-functions/game/survey-answers.js` |
| GET | `/games/{gameId}/survey/people` | **Cognito** | `lambda-functions/game/survey-host.js` |
