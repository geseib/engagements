 ...
 *
 * COPIED BYTE FOR BYTE into lambda-functions/game/csv.js, only because
 * survey-kinds.js requires it and game/ carries a copy of that (see its header).
 * tests/survey-kinds.js §9 holds the copies equal.
 */
