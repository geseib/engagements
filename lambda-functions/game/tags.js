 ...
 *
 * COPIED BYTE FOR BYTE into lambda-functions/game/tags.js, only because
 * csv.js requires it and game/ carries survey-kinds.js and csv.js (see
 * survey-kinds.js's header). tests/survey-kinds.js §9 holds the copies equal.
 */
