 ...
 *
 * AND A THIRD COPY, OF THIS FILE ITSELF: lambda-functions/game/survey-kinds.js,
 * byte for byte, with the ./csv and ./tags it requires. A running survey checks
 * every answer against its question's kind, scale and options in game/
 * (survey-questions.js, survey-answer.js), and a Lambda bundle is its CodeUri.
 * tests/survey-kinds.js §9 fails the build if the copies drift.
 *
